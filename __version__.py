"""
__version__.py — Fonte única de versão do PesquisAI Additions v0.4.0.

Este pacote contém as adições do PesquisAI v0.4.0:
  - Skill grant_finder
...
__codename__: str = "International & Mobile"
